"""AssessmentStore: SQLite-backed persistence for the central Assessment object.

Mirrors storage/registry.py's pattern (plain sqlite3, JSON blob columns for
nested structures) rather than pulling in an ORM for one table.
"""
